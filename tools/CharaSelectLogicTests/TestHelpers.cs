    ...
    string transitionSafety = "safe")
{
    return TitleBackgroundDeliveryDiagnostic.BuildSummary(
        ...
        characterNumericallyVerified: characterNumericallyVerified);
}
    ...
    string verifyEnvironment = "not-evaluated")
{
    return new TitleBackgroundQuickCheckInput(
        ...
        VerifyPoseHold: verifyPoseHold,
        VerifyCameraJitter: verifyCameraJitter,
        VerifyRotationJitter: verifyRotationJitter,
        VerifyFacing: verifyFacing,
        VerifyFraming: verifyFraming,
        VerifySuppression: verifySuppression,
        VerifyLoginStop: verifyLoginStop,
