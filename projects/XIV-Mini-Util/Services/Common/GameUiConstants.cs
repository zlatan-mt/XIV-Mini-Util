...
public static class GameUiConstants
{
    ...
    public const string MateriaRetrieveDialogAddonName = "MateriaRetrieveDialog";
    ...
    // MateriaRetrieveDialog: 確認要求は実機観測後に変更できるよう一箇所へ集約する
    public const int MateriaRetrieveConfirmCallbackValue = 0;
